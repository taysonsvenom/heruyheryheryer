...
@app.on_message(filters.command(["/block","block","حظر"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["/unblock","unblock","الغاء حظر"], "") & SUDOERS)
@language
...
@app.on_message(filters.command(["blocked","/blocked","blockedusers","/blockedusers","blusers","/blusers","المحظورين","قائمة الحظر"], "") & SUDOERS)
@language
