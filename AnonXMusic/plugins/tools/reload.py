...
@app.on_message(
    filters.command(["/admincache","admincache", "/reload","reload","/refresh","refresh","ريلود"],"") & filters.group & ~BANNED_USERS
)
@language
...
@app.on_message(filters.command(["/reboot","reboot","ريبوت"], "") & filters.group & ~BANNED_USERS)
@AdminActual
